...
export const metadata: Metadata = {
  metadataBase: new URL('https://tokamak-bridge-test.netlify.app/'),
  title: 'Tokamak Bridge',
  viewport: 'width=device-width,user-scalable=no,initial-scale=1, maximum-scale=1, minimum-scale=1',
  description: 'Tokamak Bridge offers a unified bridge and swap experience between Ethereum and Titan Network.',
