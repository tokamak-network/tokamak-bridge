...
export const supportedTokens: SupportedTokens_T = [
  ...
  },
  {
    ...
    address: {
      ...
      TOKAMAK_GOERLI: TOKAMAK_GOERLI_CONTRACTS.TON_ADDRESS,
    },
    decimals: 18,
    isNativeCurrency: [
      SupportedChainId.TOKAMAK_MAINNET,
      SupportedChainId.TOKAMAK_GOERLI,
    ],
  },
  {
    tokenName: "WTON",
    address: {
      ...
      TOKAMAK_GOERLI: TOKAMAK_GOERLI_CONTRACTS.WTON_ADDRESS,
    },
    decimals: 27,
...

  {
    ...
    address: {
      ...
      TOKAMAK_GOERLI: TOKAMAK_GOERLI_CONTRACTS.TOS_ADDRESS,
    },
    decimals: 18,
    isNativeCurrency: null,
  },
  {
    ...
    address: {
      ...
      TOKAMAK_GOERLI: TOKAMAK_GOERLI_CONTRACTS.DOC_ADDRESS,
    },
    decimals: 18,
    isNativeCurrency: null,
  },
  {
    ...
    address: {
      ...
      TOKAMAK_GOERLI: TOKAMAK_GOERLI_CONTRACTS.AURA_ADDRESS,
    },
    decimals: 18,
    isNativeCurrency: null,
  },
  {
    ...
    address: {
      ...
      TOKAMAK_GOERLI: TOKAMAK_GOERLI_CONTRACTS.LYDA_ADDRESS,
    },
    decimals: 18,
    isNativeCurrency: null,
  },
  {
    ...
    address: {
      ...
      TOKAMAK_GOERLI: TOKAMAK_GOERLI_CONTRACTS.USDC_ADDRESS,
    },
    decimals: 6,
    isNativeCurrency: null,
  },
