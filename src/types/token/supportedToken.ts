...
export const supportedTokens: SupportedTokens_T = [
  ...
  },
  {
    ...
    address: {
      ...
      DARIAN: TOKAMAK_GOERLI_CONTRACTS.TON_ADDRESS,
    },
    decimals: 18,
    isNativeCurrency: [
      SupportedChainId.TOKAMAK_MAINNET,
      SupportedChainId.DARIAN,
    ],
  },
  {
    tokenName: "WTON",
    address: {
      ...
      DARIAN: TOKAMAK_GOERLI_CONTRACTS.WTON_ADDRESS,
    },
    decimals: 27,
...

  {
    ...
    address: {
      ...
      DARIAN: TOKAMAK_GOERLI_CONTRACTS.TOS_ADDRESS,
    },
    decimals: 18,
    isNativeCurrency: null,
  },
  {
    ...
    address: {
      ...
      DARIAN: TOKAMAK_GOERLI_CONTRACTS.DOC_ADDRESS,
    },
    decimals: 18,
    isNativeCurrency: null,
  },
  {
    ...
    address: {
      ...
      DARIAN: TOKAMAK_GOERLI_CONTRACTS.AURA_ADDRESS,
    },
    decimals: 18,
    isNativeCurrency: null,
  },
  {
    ...
    address: {
      ...
      DARIAN: TOKAMAK_GOERLI_CONTRACTS.LYDA_ADDRESS,
    },
    decimals: 18,
    isNativeCurrency: null,
  },
  {
    ...
    address: {
      ...
      DARIAN: TOKAMAK_GOERLI_CONTRACTS.USDC_ADDRESS,
    },
    decimals: 6,
    isNativeCurrency: null,
  },
